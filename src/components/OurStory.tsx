...
const OurStory: FC<OurStoryProps> = ({ }) => {
    return <div id='about' className='w-full bg-gray-50 text-neutral-900'>
        <MaxWidthWrapper className='py-20 '>
            <div className="h-full border border-cyan-400 w-full sm:w-[50vw] xl:w-[35rem] mr-10 mb-7 float-left overflow-hidden rounded-lg">
