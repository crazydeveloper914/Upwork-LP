...
const Target: FC<TargetProps> = ({ }) => {
    return <div className='w-full'>
        <MaxWidthWrapper className='my-20 flex flex-col'>
            ...
            <div className="flex relative flex-col max-w-xl my-20 bg-cyan-950 p-5 sm:p-10 rounded-3xl text-white">
            ...
            <div className="grid  w-full grid-cols-1 md:grid-cols-2 lg:flex gap-5 lg:gap-10 justify-center flex-wrap text-white">
                <div className="w-full lg:w-[25rem] cursor-pointer border-2 overflow-hidden border-cyan-950 relative group bg-cyan-950 p-5 lg:p-10 rounded-3xl">
